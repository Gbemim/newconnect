...
import { getAccount, authUser, registerUser, updateAccount, logoutUser } from '../controllers/oneUserController.js'
...
router.route('/logout').get(authUser).put(protect, logoutUser)
